...
delegated: Vinext/React static export for review on GitHub Pages and later transfer to Reg.ru. All fonts, images and scripts are served locally.

## Users

People in Krasnodar choosing a private massage session and wanting to understand the format, duration, price and rules before writing to the practitioner.
...
The page must remain readable and operable on mobile and desktop, support keyboard navigation, maintain WCAG AA text contrast and respect reduced-motion preferences.
